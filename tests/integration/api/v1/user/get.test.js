...
describe("GET /api/v1/user", () => {
  ...
  describe("Default user", () => {
    test("With valid session", async () => {
      ...
      const activeteUser = await orchestrator.activateUser(createdUser);
      ...
      expect(responseBody).toEqual({
        ...
        updated_at: activeteUser.updated_at.toISOString(),
      });
    ...
    test("With session about to expire", async () => {
      ...
      const activeteUser = await orchestrator.activateUser(createUser1);
